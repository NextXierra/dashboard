...
<div class="row align-items-center mb-5">
    <div class="col-md-8">
        ...
        <h1 class="display-5 mb-2" style="font-size: 2.8rem; letter-spacing: -1px;">EDIT MATA KULIAH</h1>
        <p class="lead text-dark font-weight-bold" style="font-size: 1.15rem; font-weight: 700;">
            Memperbarui data mata kuliah <span class="text-decoration-underline"><?= esc($matakuliah['Nama_MK']) ?></span> di sistem.
        </p>
    </div>
...
<div class="row">
    <div class="col-lg-12">
        <div class="neo-card" style="background-color: #fff; border-bottom: 8px solid #141414;">
            <form action="<?= base_url('matakuliah/update/' . $matakuliah['Kode_MK']) ?>" method="POST">
                <?= csrf_field() ?>
                ...
                <div class="neo-form-group">
                    ...
                    <input type="text" class="form-control form-control-lg text-dark fw-bold border-3 border-dark" id="Nama_MK" name="Nama_MK" value="<?= old('Nama_MK', $matakuliah['Nama_MK']) ?>" required maxlength="100">
                </div>
                ...
                <div class="d-grid mt-4">
                    <button type="submit" class="btn btn-neo btn-primary py-3 btn-lg text-dark border-3 border-dark" style="background-color: #6fc59a;">
                        <i class="fa-solid fa-square-check me-2"></i> Perbarui Mata Kuliah
                    </button>
                </div>
            </form>
        </div>
