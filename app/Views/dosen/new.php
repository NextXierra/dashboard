...
<div class="row align-items-center mb-5">
    <div class="col-md-8">
        ...
        <h1 class="display-5 mb-2" style="font-size: 2.8rem; letter-spacing: -1px;">TAMBAH DOSEN</h1>
        <p class="lead text-dark font-weight-bold" style="font-size: 1.15rem; font-weight: 700;">
            Silakan masukkan data dosen pengajar baru ke dalam sistem basis data.
        </p>
    </div>
        ...
        <div class="neo-card" style="background-color: #fff; border-bottom: 8px solid #141414;">
            <form action="<?= base_url('dosen/create') ?>" method="POST">
                ...
                <div class="neo-form-group">
                    ...
                    <input type="text" class="form-control form-control-lg text-dark fw-bold border-3 border-dark" id="Nama_Dosen" name="Nama_Dosen" value="<?= old('Nama_Dosen') ?>" placeholder="Contoh: Dr. Eko Suryadi, M.T." required maxlength="100">
                </div>
                ...
                <div class="d-grid mt-4">
                    <button type="submit" class="btn btn-neo btn-primary py-3 btn-lg text-dark border-3 border-dark" style="background-color: #6fc59a;">
                        <i class="fa-solid fa-circle-check me-2"></i> Simpan Data Dosen
                    </button>
                </div>
            </form>
        </div>
